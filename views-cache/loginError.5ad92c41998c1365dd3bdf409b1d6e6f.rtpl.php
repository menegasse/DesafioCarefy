...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="/resorce/site/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="login-box lockscreen-logo">
        <img src="/resorce/site/dist/img/logo/cafyLogo.png">
  </div>
  <!-- /.login-logo -->

  <div class="login-box-body">
    <p class="login-box-msg " style="color:red">Usuário ou Senha incorreto.</p>
    ...
    <!-- /.social-auth-links -->
    <a href="/user/forgot/">Esqueci minha senha</a> <br><br>
    <a href="/user/create/" class="text-center">Cadastrar-se</a>
...
<!-- iCheck -->
<script src="/resorce/site/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
