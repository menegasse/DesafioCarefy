...
<head>
  ...
  <title>Carefy | Esqueci a Senha</title>
...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
      <img src="/resorce/site/dist/img/logo/cafyLogo.png" style="background-size: contain;">
  </div>
  ...
  <div class="help-block text-center">
    <p style="color:#ffffff">Digite seu e-mail e receba as instruções para redefinir a sua senha.</p>
  </div>
  <div class="text-center">
    <a href="/" class="btn btn-danger">Ou entre com um usuário diferente</a>
  </div>
</div>
<!-- /.center -->
